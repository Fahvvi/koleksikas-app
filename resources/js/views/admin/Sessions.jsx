            ...
            {isDetailModalOpen && selectedSession && (
                <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-kas-dark/60 backdrop-blur-sm animate-fade-in">
                    <div className="bg-white rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden flex flex-col">
                        <div className="bg-kas-dark p-6 border-b border-gray-100 flex justify-between items-start text-white relative">
                            <div className="pr-8">
                        ...
                        <div className="p-6 space-y-6 bg-kas-bg/30">
